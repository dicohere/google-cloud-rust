...
impl super::stub::CloudQuotas for CloudQuotas {
    ...
    async fn update_quota_preference(
        ...
        let path =
            format!("/v1/{}",
                    {
                        let arg = &req.quota_preference.as_ref().ok_or_else(|| gaxi::path_parameter::missing("quota_preference"))?.name;
                        if arg.is_empty() {
