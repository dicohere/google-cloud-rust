...
where T: super::stub::Compliance + std::fmt::Debug + Send + Sync {
    inner: T,
}
#[cfg(all(target_arch = "wasm32", target_os = "unknown"))]
#[derive(Clone, Debug)]
pub struct Compliance<T>
where T: super::stub::Compliance + std::fmt::Debug {
    inner: T,
}
...
where T: super::stub::Compliance + std::fmt::Debug + Send + Sync {
    ...
    async fn repeat_data_path_trailing_resource(
        ...
        self.inner.repeat_data_path_trailing_resource(req, options).await
    }
...
#[derive(Clone, Debug)]
pub struct Echo<T>
where T: super::stub::Echo + std::fmt::Debug + Send + Sync {
    inner: T,
}
#[cfg(all(target_arch = "wasm32", target_os = "unknown"))]
#[derive(Clone, Debug)]
pub struct Echo<T>
where T: super::stub::Echo + std::fmt::Debug {
    inner: T,
}
...
where T: super::stub::Identity + std::fmt::Debug + Send + Sync {
    inner: T,
}
#[cfg(all(target_arch = "wasm32", target_os = "unknown"))]
#[derive(Clone, Debug)]
pub struct Identity<T>
where T: super::stub::Identity + std::fmt::Debug {
    inner: T,
}
...
where T: super::stub::Messaging + std::fmt::Debug + Send + Sync {
    inner: T,
}
#[cfg(all(target_arch = "wasm32", target_os = "unknown"))]
#[derive(Clone, Debug)]
pub struct Messaging<T>
where T: super::stub::Messaging + std::fmt::Debug {
    inner: T,
}
...
where T: super::stub::SequenceService + std::fmt::Debug + Send + Sync {
    inner: T,
}
#[cfg(all(target_arch = "wasm32", target_os = "unknown"))]
#[derive(Clone, Debug)]
pub struct SequenceService<T>
where T: super::stub::SequenceService + std::fmt::Debug {
    inner: T,
}
...
where T: super::stub::Testing + std::fmt::Debug + Send + Sync {
    inner: T,
}
#[cfg(all(target_arch = "wasm32", target_os = "unknown"))]
#[derive(Clone, Debug)]
pub struct Testing<T>
where T: super::stub::Testing + std::fmt::Debug {
    inner: T,
}
