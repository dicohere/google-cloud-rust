...
#[derive(Clone, Debug)]
pub struct Applications<T>
where T: super::stub::Applications + std::fmt::Debug {
    inner: T,
}
...
#[derive(Clone, Debug)]
pub struct Services<T>
where T: super::stub::Services + std::fmt::Debug {
    inner: T,
}
...
#[derive(Clone, Debug)]
pub struct Instances<T>
where T: super::stub::Instances + std::fmt::Debug {
    inner: T,
}
...
#[derive(Clone, Debug)]
pub struct Firewall<T>
where T: super::stub::Firewall + std::fmt::Debug {
    inner: T,
}
...
#[derive(Clone, Debug)]
pub struct AuthorizedDomains<T>
where T: super::stub::AuthorizedDomains + std::fmt::Debug {
    inner: T,
}
...
#[derive(Clone, Debug)]
pub struct AuthorizedCertificates<T>
where T: super::stub::AuthorizedCertificates + std::fmt::Debug {
    inner: T,
}
...
#[derive(Clone, Debug)]
pub struct DomainMappings<T>
where T: super::stub::DomainMappings + std::fmt::Debug {
    inner: T,
}
