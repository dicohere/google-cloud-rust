...
impl super::stub::DataCatalog for DataCatalog {
    ...
    async fn update_tag_template(
        ...
        let path =
            format!("/v1/{}",
                    {
                        let arg = &req.tag_template.as_ref().ok_or_else(|| gaxi::path_parameter::missing("tag_template"))?.name;
                        if arg.is_empty() {
    ...
    async fn retrieve_effective_config(
        ...
        let path =
            format!("/v1/{}:retrieveEffectiveConfig",
                    {
                        let arg = &req.name;
                        if arg.is_empty() {
                            return Err(gaxi::path_parameter::missing("name"));
...
impl super::stub::PolicyTagManager for PolicyTagManager {
    ...
    async fn update_taxonomy(
        ...
        let path =
            format!("/v1/{}",
                    {
                        let arg = &req.taxonomy.as_ref().ok_or_else(|| gaxi::path_parameter::missing("taxonomy"))?.name;
                        if arg.is_empty() {
    ...
    async fn update_policy_tag(
        ...
        let path =
            format!("/v1/{}",
                    {
                        let arg = &req.policy_tag.as_ref().ok_or_else(|| gaxi::path_parameter::missing("policy_tag"))?.name;
                        if arg.is_empty() {
