...
#[derive(Clone, Debug)]
pub struct DataCatalog<T>
where T: super::stub::DataCatalog + std::fmt::Debug {
    inner: T,
}
...
#[derive(Clone, Debug)]
pub struct PolicyTagManager<T>
where T: super::stub::PolicyTagManager + std::fmt::Debug {
    inner: T,
}
...
#[derive(Clone, Debug)]
pub struct PolicyTagManagerSerialization<T>
where T: super::stub::PolicyTagManagerSerialization + std::fmt::Debug {
    inner: T,
}
