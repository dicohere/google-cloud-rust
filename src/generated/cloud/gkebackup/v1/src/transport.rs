...
impl super::stub::BackupForGKE for BackupForGKE {
    ...
    async fn update_backup_plan(
        ...
        let path =
            format!("/v1/{}",
                    {
                        let arg = &req.backup_plan.as_ref().ok_or_else(|| gaxi::path_parameter::missing("backup_plan"))?.name;
                        if arg.is_empty() {
    ...
    async fn update_backup_channel(
        ...
        let path =
            format!("/v1/{}",
                    {
                        let arg = &req.backup_channel.as_ref().ok_or_else(|| gaxi::path_parameter::missing("backup_channel"))?.name;
                        if arg.is_empty() {
    ...
    async fn update_restore_plan(
        ...
        let path =
            format!("/v1/{}",
                    {
                        let arg = &req.restore_plan.as_ref().ok_or_else(|| gaxi::path_parameter::missing("restore_plan"))?.name;
                        if arg.is_empty() {
    ...
    async fn update_restore_channel(
        ...
        let path =
            format!("/v1/{}",
                    {
                        let arg = &req.restore_channel.as_ref().ok_or_else(|| gaxi::path_parameter::missing("restore_channel"))?.name;
                        if arg.is_empty() {
    ...
    async fn update_restore(
        ...
        let path =
            format!("/v1/{}",
                    {
                        let arg = &req.restore.as_ref().ok_or_else(|| gaxi::path_parameter::missing("restore"))?.name;
                        if arg.is_empty() {
    ...
    async fn get_backup_index_download_url(
        ...
        let path =
            format!("/v1/{}:getBackupIndexDownloadUrl",
                    {
                        let arg = &req.backup;
                        if arg.is_empty() {
