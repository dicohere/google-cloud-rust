...
impl super::stub::CrossNetworkAutomationService for CrossNetworkAutomationService {
    async fn list_service_connection_maps(
        ...
        let path =
            format!("/v1/{}/serviceConnectionMaps",
                    {
                        let arg = &req.parent;
                        if arg.is_empty() {
    ...
    async fn create_service_connection_map(
        ...
        self.inner.execute(
            builder,
            Some(req.service_connection_map),
            options,
        ).await
    }
    ...
    async fn update_service_connection_map(
        ...
        let path =
            format!("/v1/{}",
                    {
                        let arg = &req.service_connection_map.as_ref().ok_or_else(|| gaxi::path_parameter::missing("service_connection_map"))?.name;
                        if arg.is_empty() {
    ...
    async fn list_service_connection_policies(
        ...
        let path =
            format!("/v1/{}/serviceConnectionPolicies",
                    {
                        let arg = &req.parent;
                        if arg.is_empty() {
                            return Err(gaxi::path_parameter::missing("parent"));
    ...
    async fn create_service_connection_policy(
        ...
        self.inner.execute(
            builder,
            Some(req.service_connection_policy),
            options,
        ).await
    }
    ...
    async fn update_service_connection_policy(
        ...
        let path =
            format!("/v1/{}",
                    {
                        let arg = &req.service_connection_policy.as_ref().ok_or_else(|| gaxi::path_parameter::missing("service_connection_policy"))?.name;
                        if arg.is_empty() {
                            return Err(gaxi::path_parameter::missing("service_connection_policy.name"));
                        }
                        arg
                    },
            );
    ...
    async fn update_service_class(
        ...
        let path =
            format!("/v1/{}",
                    {
                        let arg = &req.service_class.as_ref().ok_or_else(|| gaxi::path_parameter::missing("service_class"))?.name;
                        if arg.is_empty() {
    ...
    async fn list_service_connection_tokens(
        ...
        let path =
            format!("/v1/{}/serviceConnectionTokens",
                    {
                        let arg = &req.parent;
                        if arg.is_empty() {
                            return Err(gaxi::path_parameter::missing("parent"));
    ...
    async fn create_service_connection_token(
        ...
        self.inner.execute(
            builder,
            Some(req.service_connection_token),
            options,
        ).await
    }
...
impl super::stub::HubService for HubService {
    ...
    async fn update_hub(
        ...
        let path =
            format!("/v1/{}",
                    {
                        let arg = &req.hub.as_ref().ok_or_else(|| gaxi::path_parameter::missing("hub"))?.name;
                        if arg.is_empty() {
    ...
    async fn update_spoke(
        ...
        let path =
            format!("/v1/{}",
                    {
                        let arg = &req.spoke.as_ref().ok_or_else(|| gaxi::path_parameter::missing("spoke"))?.name;
                        if arg.is_empty() {
