...
#[derive(Clone, Debug)]
pub struct CrossNetworkAutomationService<T>
where T: super::stub::CrossNetworkAutomationService + std::fmt::Debug {
    inner: T,
}
...
#[derive(Clone, Debug)]
pub struct HubService<T>
where T: super::stub::HubService + std::fmt::Debug {
    inner: T,
}
...
#[derive(Clone, Debug)]
pub struct PolicyBasedRoutingService<T>
where T: super::stub::PolicyBasedRoutingService + std::fmt::Debug {
    inner: T,
}
