...
impl super::stub::WebSecurityScanner for WebSecurityScanner {
    ...
    async fn update_scan_config(
        ...
        let path =
            format!("/v1/{}",
                    {
                        let arg = &req.scan_config.as_ref().ok_or_else(|| gaxi::path_parameter::missing("scan_config"))?.name;
                        if arg.is_empty() {
