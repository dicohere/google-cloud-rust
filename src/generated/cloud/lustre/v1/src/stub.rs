...
/// Defines the trait used to implement [super::client::Lustre].
///
/// Application developers may need to implement this trait to mock
/// `client::Lustre`.  In other use-cases, application developers only
/// use `client::Lustre` and need not be concerned with this trait or
/// its implementations.
///
...
pub trait Lustre: std::fmt::Debug + Send + Sync {
    ...
    /// Implements [super::client::Lustre::list_instances].
    fn list_instances(
        &self,
    ...
    /// Implements [super::client::Lustre::get_instance].
    fn get_instance(
        &self,
    ...
    /// Implements [super::client::Lustre::create_instance].
    fn create_instance(
        &self,
    ...
    /// Implements [super::client::Lustre::update_instance].
    fn update_instance(
        &self,
    ...
    /// Implements [super::client::Lustre::delete_instance].
    fn delete_instance(
        &self,
    ...
    /// Implements [super::client::Lustre::import_data].
    fn import_data(
        &self,
    ...
    /// Implements [super::client::Lustre::export_data].
    fn export_data(
        &self,
    ...
    /// Implements [super::client::Lustre::list_locations].
    fn list_locations(
        &self,
    ...
    /// Implements [super::client::Lustre::get_location].
    fn get_location(
        &self,
    ...
    /// Implements [super::client::Lustre::list_operations].
    fn list_operations(
        &self,
    ...
    /// Implements [super::client::Lustre::get_operation].
    fn get_operation(
        &self,
    ...
    /// Implements [super::client::Lustre::delete_operation].
    fn delete_operation(
        &self,
    ...
    /// Implements [super::client::Lustre::cancel_operation].
    fn cancel_operation(
        &self,
...
pub trait Lustre: std::fmt::Debug {
