...
/// Implements [Lustre](super::stub::Lustre) using a [gaxi::http::ReqwestClient].
#[derive(Clone)]
pub struct Lustre {
    inner: gaxi::http::ReqwestClient,
}

impl std::fmt::Debug for Lustre {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::result::Result<(), std::fmt::Error> {
        f.debug_struct("Lustre")
...
impl super::stub::Lustre for Lustre {
