...
#[derive(Clone, Debug)]
pub struct Builds<T>
where T: super::stub::Builds + std::fmt::Debug {
    inner: T,
}
...
#[derive(Clone, Debug)]
pub struct Jobs<T>
where T: super::stub::Jobs + std::fmt::Debug {
    inner: T,
}
...
#[derive(Clone, Debug)]
pub struct Revisions<T>
where T: super::stub::Revisions + std::fmt::Debug {
    inner: T,
}
...
#[derive(Clone, Debug)]
pub struct Tasks<T>
where T: super::stub::Tasks + std::fmt::Debug {
    inner: T,
}
