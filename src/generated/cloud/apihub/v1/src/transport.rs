...
impl super::stub::ApiHub for ApiHub {
    ...
    async fn update_api(
        ...
        let path =
            format!("/v1/{}",
                    {
                        let arg = &req.api.as_ref().ok_or_else(|| gaxi::path_parameter::missing("api"))?.name;
                        if arg.is_empty() {
    ...
    async fn update_spec(
        ...
        let path =
            format!("/v1/{}",
                    {
                        let arg = &req.spec.as_ref().ok_or_else(|| gaxi::path_parameter::missing("spec"))?.name;
                        if arg.is_empty() {
    ...
    async fn update_deployment(
        ...
        let path =
            format!("/v1/{}",
                    {
                        let arg = &req.deployment.as_ref().ok_or_else(|| gaxi::path_parameter::missing("deployment"))?.name;
                        if arg.is_empty() {
    ...
    async fn update_attribute(
        ...
        let path =
            format!("/v1/{}",
                    {
                        let arg = &req.attribute.as_ref().ok_or_else(|| gaxi::path_parameter::missing("attribute"))?.name;
                        if arg.is_empty() {
    ...
    async fn update_external_api(
        ...
        let path =
            format!("/v1/{}",
                    {
                        let arg = &req.external_api.as_ref().ok_or_else(|| gaxi::path_parameter::missing("external_api"))?.name;
                        if arg.is_empty() {
...
impl super::stub::ApiHubDependencies for ApiHubDependencies {
    ...
    async fn update_dependency(
        ...
        let path =
            format!("/v1/{}",
                    {
                        let arg = &req.dependency.as_ref().ok_or_else(|| gaxi::path_parameter::missing("dependency"))?.name;
                        if arg.is_empty() {
...
impl super::stub::HostProjectRegistrationService for HostProjectRegistrationService {
    async fn create_host_project_registration(
        ...
        let path =
            format!("/v1/{}/hostProjectRegistrations",
                    {
                        let arg = &req.parent;
                        if arg.is_empty() {
                            return Err(gaxi::path_parameter::missing("parent"));
        ...
        self.inner.execute(
            builder,
            Some(req.host_project_registration),
            options,
        ).await
    }
...
impl super::stub::LintingService for LintingService {
    ...
    async fn update_style_guide(
        ...
        let path =
            format!("/v1/{}",
                    {
                        let arg = &req.style_guide.as_ref().ok_or_else(|| gaxi::path_parameter::missing("style_guide"))?.name;
                        if arg.is_empty() {
...
impl super::stub::Provisioning for Provisioning {
    ...
    async fn lookup_api_hub_instance(
        ...
        let path =
            format!("/v1/{}/apiHubInstances:lookup",
                    {
                        let arg = &req.parent;
                        if arg.is_empty() {
                            return Err(gaxi::path_parameter::missing("parent"));
...
impl super::stub::RuntimeProjectAttachmentService for RuntimeProjectAttachmentService {
    async fn create_runtime_project_attachment(
        ...
        let path =
            format!("/v1/{}/runtimeProjectAttachments",
                    {
                        let arg = &req.parent;
                        if arg.is_empty() {
                            return Err(gaxi::path_parameter::missing("parent"));
        ...
        self.inner.execute(
            builder,
            Some(req.runtime_project_attachment),
            options,
        ).await
    }
    ...
    async fn lookup_runtime_project_attachment(
        ...
        let path =
            format!("/v1/{}:lookupRuntimeProjectAttachment",
                    {
                        let arg = &req.name;
                        if arg.is_empty() {
                            return Err(gaxi::path_parameter::missing("name"));
