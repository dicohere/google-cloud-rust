...
#[derive(Clone, Debug)]
pub struct ApiHub<T>
where T: super::stub::ApiHub + std::fmt::Debug {
    inner: T,
}
...
#[derive(Clone, Debug)]
pub struct ApiHubDependencies<T>
where T: super::stub::ApiHubDependencies + std::fmt::Debug {
    inner: T,
}
...
#[derive(Clone, Debug)]
pub struct HostProjectRegistrationService<T>
where T: super::stub::HostProjectRegistrationService + std::fmt::Debug {
    inner: T,
}
...
#[derive(Clone, Debug)]
pub struct LintingService<T>
where T: super::stub::LintingService + std::fmt::Debug {
    inner: T,
}
...
#[derive(Clone, Debug)]
pub struct ApiHubPlugin<T>
where T: super::stub::ApiHubPlugin + std::fmt::Debug {
    inner: T,
}
...
#[derive(Clone, Debug)]
pub struct Provisioning<T>
where T: super::stub::Provisioning + std::fmt::Debug {
    inner: T,
}
...
#[derive(Clone, Debug)]
pub struct RuntimeProjectAttachmentService<T>
where T: super::stub::RuntimeProjectAttachmentService + std::fmt::Debug {
    inner: T,
}
