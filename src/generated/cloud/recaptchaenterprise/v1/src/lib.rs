...
//!
//! This crate contains traits, types, and functions to interact with reCAPTCHA Enterprise API
...
const DEFAULT_HOST: &str = "https://recaptchaenterprise.googleapis.com/";
