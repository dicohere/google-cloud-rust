...
impl super::stub::CertificateManager for CertificateManager {
    ...
    async fn update_certificate_map(
        ...
        let path =
            format!("/v1/{}",
                    {
                        let arg = &req.certificate_map.as_ref().ok_or_else(|| gaxi::path_parameter::missing("certificate_map"))?.name;
                        if arg.is_empty() {
    ...
    async fn list_certificate_map_entries(
        ...
        let path =
            format!("/v1/{}/certificateMapEntries",
                    {
                        let arg = &req.parent;
                        if arg.is_empty() {
                            return Err(gaxi::path_parameter::missing("parent"));
    ...
    async fn create_certificate_map_entry(
        ...
        self.inner.execute(
            builder,
            Some(req.certificate_map_entry),
            options,
        ).await
    }
    ...
    async fn update_certificate_map_entry(
        ...
        let path =
            format!("/v1/{}",
                    {
                        let arg = &req.certificate_map_entry.as_ref().ok_or_else(|| gaxi::path_parameter::missing("certificate_map_entry"))?.name;
                        if arg.is_empty() {
    ...
    async fn update_dns_authorization(
        ...
        let path =
            format!("/v1/{}",
                    {
                        let arg = &req.dns_authorization.as_ref().ok_or_else(|| gaxi::path_parameter::missing("dns_authorization"))?.name;
                        if arg.is_empty() {
    ...
    async fn list_certificate_issuance_configs(
        ...
        let path =
            format!("/v1/{}/certificateIssuanceConfigs",
                    {
                        let arg = &req.parent;
                        if arg.is_empty() {
                            return Err(gaxi::path_parameter::missing("parent"));
    ...
    async fn create_certificate_issuance_config(
        ...
        self.inner.execute(
            builder,
            Some(req.certificate_issuance_config),
            options,
        ).await
    }
    ...
    async fn update_trust_config(
        ...
        let path =
            format!("/v1/{}",
                    {
                        let arg = &req.trust_config.as_ref().ok_or_else(|| gaxi::path_parameter::missing("trust_config"))?.name;
                        if arg.is_empty() {
