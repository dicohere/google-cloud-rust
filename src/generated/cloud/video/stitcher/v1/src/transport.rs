...
impl super::stub::VideoStitcherService for VideoStitcherService {
    ...
    async fn update_cdn_key(
        ...
        let path =
            format!("/v1/{}",
                    {
                        let arg = &req.cdn_key.as_ref().ok_or_else(|| gaxi::path_parameter::missing("cdn_key"))?.name;
                        if arg.is_empty() {
    ...
    async fn update_slate(
        ...
        let path =
            format!("/v1/{}",
                    {
                        let arg = &req.slate.as_ref().ok_or_else(|| gaxi::path_parameter::missing("slate"))?.name;
                        if arg.is_empty() {
    ...
    async fn update_live_config(
        ...
        let path =
            format!("/v1/{}",
                    {
                        let arg = &req.live_config.as_ref().ok_or_else(|| gaxi::path_parameter::missing("live_config"))?.name;
                        if arg.is_empty() {
    ...
    async fn update_vod_config(
        ...
        let path =
            format!("/v1/{}",
                    {
                        let arg = &req.vod_config.as_ref().ok_or_else(|| gaxi::path_parameter::missing("vod_config"))?.name;
                        if arg.is_empty() {
