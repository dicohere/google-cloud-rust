...
impl super::stub::LivestreamService for LivestreamService {
    ...
    async fn update_input(
        ...
        let path =
            format!("/v1/{}",
                    {
                        let arg = &req.input.as_ref().ok_or_else(|| gaxi::path_parameter::missing("input"))?.name;
                        if arg.is_empty() {
    ...
    async fn update_dvr_session(
        ...
        let path =
            format!("/v1/{}",
                    {
                        let arg = &req.dvr_session.as_ref().ok_or_else(|| gaxi::path_parameter::missing("dvr_session"))?.name;
                        if arg.is_empty() {
    ...
    async fn update_pool(
        ...
        let path =
            format!("/v1/{}",
                    {
                        let arg = &req.pool.as_ref().ok_or_else(|| gaxi::path_parameter::missing("pool"))?.name;
                        if arg.is_empty() {
