...
#[derive(Clone, Debug)]
pub struct Autokey<T>
where T: super::stub::Autokey + std::fmt::Debug {
    inner: T,
}
...
#[derive(Clone, Debug)]
pub struct AutokeyAdmin<T>
where T: super::stub::AutokeyAdmin + std::fmt::Debug {
    inner: T,
}
...
#[derive(Clone, Debug)]
pub struct EkmService<T>
where T: super::stub::EkmService + std::fmt::Debug {
    inner: T,
}
...
#[derive(Clone, Debug)]
pub struct KeyManagementService<T>
where T: super::stub::KeyManagementService + std::fmt::Debug {
    inner: T,
}
