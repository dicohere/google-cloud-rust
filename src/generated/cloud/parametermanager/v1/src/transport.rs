...
impl super::stub::ParameterManager for ParameterManager {
    ...
    async fn update_parameter(
        ...
        let path =
            format!("/v1/{}",
                    {
                        let arg = &req.parameter.as_ref().ok_or_else(|| gaxi::path_parameter::missing("parameter"))?.name;
                        if arg.is_empty() {
    ...
    async fn update_parameter_version(
        ...
        let path =
            format!("/v1/{}",
                    {
                        let arg = &req.parameter_version.as_ref().ok_or_else(|| gaxi::path_parameter::missing("parameter_version"))?.name;
                        if arg.is_empty() {
