...
pub mod conversation_participant {
    ...
    pub enum Participant {
        ...
        /// projects/{project}/locations/{location}/conversations/{conversation}/participants/{participant}
        DialogflowParticipantName(#[serde_as(as = "serde_with::DefaultOnNull<_>")]std::string::String),
...
pub mod annotator_selector {
    ...
    pub mod summarization_config {
        ...
        pub enum ModelSource {
            ...
            ConversationProfile(#[serde_as(as = "serde_with::DefaultOnNull<_>")]std::string::String),
            /// Default summarization model to be used.
            SummarizationModel(#[serde_as(as = "serde_with::DefaultOnNull<_>")]crate::model::annotator_selector::summarization_config::SummarizationModel),
        }
    }
