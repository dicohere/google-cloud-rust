...
impl super::stub::CompanyService for CompanyService {
    ...
    async fn update_company(
        ...
        let path =
            format!("/v4/{}",
                    {
                        let arg = &req.company.as_ref().ok_or_else(|| gaxi::path_parameter::missing("company"))?.name;
                        if arg.is_empty() {
...
impl super::stub::TenantService for TenantService {
    ...
    async fn update_tenant(
        ...
        let path =
            format!("/v4/{}",
                    {
                        let arg = &req.tenant.as_ref().ok_or_else(|| gaxi::path_parameter::missing("tenant"))?.name;
                        if arg.is_empty() {
