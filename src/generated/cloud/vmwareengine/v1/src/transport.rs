...
impl super::stub::VmwareEngine for VmwareEngine {
    ...
    async fn update_private_cloud(
        ...
        let path =
            format!("/v1/{}",
                    {
                        let arg = &req.private_cloud.as_ref().ok_or_else(|| gaxi::path_parameter::missing("private_cloud"))?.name;
                        if arg.is_empty() {
    ...
    async fn update_cluster(
        ...
        let path =
            format!("/v1/{}",
                    {
                        let arg = &req.cluster.as_ref().ok_or_else(|| gaxi::path_parameter::missing("cluster"))?.name;
                        if arg.is_empty() {
    ...
    async fn fetch_network_policy_external_addresses(
        ...
        let path =
            format!("/v1/{}:fetchExternalAddresses",
                    {
    ...
    async fn update_external_address(
        ...
        let path =
            format!("/v1/{}",
                    {
                        let arg = &req.external_address.as_ref().ok_or_else(|| gaxi::path_parameter::missing("external_address"))?.name;
                        if arg.is_empty() {
    ...
    async fn update_subnet(
        ...
        let path =
            format!("/v1/{}",
                    {
                        let arg = &req.subnet.as_ref().ok_or_else(|| gaxi::path_parameter::missing("subnet"))?.name;
                        if arg.is_empty() {
    ...
    async fn update_external_access_rule(
        ...
        let path =
            format!("/v1/{}",
                    {
                        let arg = &req.external_access_rule.as_ref().ok_or_else(|| gaxi::path_parameter::missing("external_access_rule"))?.name;
                        if arg.is_empty() {
    ...
    async fn update_logging_server(
        ...
        let path =
            format!("/v1/{}",
                    {
                        let arg = &req.logging_server.as_ref().ok_or_else(|| gaxi::path_parameter::missing("logging_server"))?.name;
                        if arg.is_empty() {
    ...
    async fn show_vcenter_credentials(
        ...
        let path =
            format!("/v1/{}:showVcenterCredentials",
                    {
                        let arg = &req.private_cloud;
                        if arg.is_empty() {
                            return Err(gaxi::path_parameter::missing("private_cloud"));
    ...
    async fn reset_vcenter_credentials(
        ...
        let path =
            format!("/v1/{}:resetVcenterCredentials",
                    {
                        let arg = &req.private_cloud;
                        if arg.is_empty() {
                            return Err(gaxi::path_parameter::missing("private_cloud"));
    ...
    async fn update_dns_forwarding(
        ...
        let path =
            format!("/v1/{}",
                    {
                        let arg = &req.dns_forwarding.as_ref().ok_or_else(|| gaxi::path_parameter::missing("dns_forwarding"))?.name;
                        if arg.is_empty() {
    ...
    async fn update_network_peering(
        ...
        let path =
            format!("/v1/{}",
                    {
                        let arg = &req.network_peering.as_ref().ok_or_else(|| gaxi::path_parameter::missing("network_peering"))?.name;
                        if arg.is_empty() {
    ...
    async fn update_network_policy(
        ...
        let path =
            format!("/v1/{}",
                    {
                        let arg = &req.network_policy.as_ref().ok_or_else(|| gaxi::path_parameter::missing("network_policy"))?.name;
                        if arg.is_empty() {
    ...
    async fn list_management_dns_zone_bindings(
        ...
        let path =
            format!("/v1/{}/managementDnsZoneBindings",
                    {
                        let arg = &req.parent;
                        if arg.is_empty() {
                            return Err(gaxi::path_parameter::missing("parent"));
    ...
    async fn create_management_dns_zone_binding(
        ...
        self.inner.execute(
            builder,
            Some(req.management_dns_zone_binding),
            options,
        ).await
    }
    ...
    async fn update_management_dns_zone_binding(
        ...
        let path =
            format!("/v1/{}",
                    {
                        let arg = &req.management_dns_zone_binding.as_ref().ok_or_else(|| gaxi::path_parameter::missing("management_dns_zone_binding"))?.name;
                        if arg.is_empty() {
                            return Err(gaxi::path_parameter::missing("management_dns_zone_binding.name"));
                        }
                        arg
                    },
            );
    ...
    async fn create_vmware_engine_network(
        ...
        let path =
            format!("/v1/{}/vmwareEngineNetworks",
                    {
                        let arg = &req.parent;
                        if arg.is_empty() {
                            return Err(gaxi::path_parameter::missing("parent"));
        ...
        self.inner.execute(
            builder,
            Some(req.vmware_engine_network),
            options,
        ).await
    }
    ...
    async fn update_vmware_engine_network(
        ...
        let path =
            format!("/v1/{}",
                    {
                        let arg = &req.vmware_engine_network.as_ref().ok_or_else(|| gaxi::path_parameter::missing("vmware_engine_network"))?.name;
                        if arg.is_empty() {
    ...
    async fn update_private_connection(
        ...
        let path =
            format!("/v1/{}",
                    {
                        let arg = &req.private_connection.as_ref().ok_or_else(|| gaxi::path_parameter::missing("private_connection"))?.name;
                        if arg.is_empty() {
