...
#[derive(Clone, Debug)]
pub struct AutoscalingPolicyService<T>
where T: super::stub::AutoscalingPolicyService + std::fmt::Debug {
    inner: T,
}
...
#[derive(Clone, Debug)]
pub struct BatchController<T>
where T: super::stub::BatchController + std::fmt::Debug {
    inner: T,
}
...
#[derive(Clone, Debug)]
pub struct ClusterController<T>
where T: super::stub::ClusterController + std::fmt::Debug {
    inner: T,
}
...
#[derive(Clone, Debug)]
pub struct JobController<T>
where T: super::stub::JobController + std::fmt::Debug {
    inner: T,
}
...
#[derive(Clone, Debug)]
pub struct NodeGroupController<T>
where T: super::stub::NodeGroupController + std::fmt::Debug {
    inner: T,
}
...
#[derive(Clone, Debug)]
pub struct SessionTemplateController<T>
where T: super::stub::SessionTemplateController + std::fmt::Debug {
    inner: T,
}
...
#[derive(Clone, Debug)]
pub struct SessionController<T>
where T: super::stub::SessionController + std::fmt::Debug {
    inner: T,
}
...
#[derive(Clone, Debug)]
pub struct WorkflowTemplateService<T>
where T: super::stub::WorkflowTemplateService + std::fmt::Debug {
    inner: T,
}
