...
pub trait Simulator: std::fmt::Debug {
    ...
    fn get_replay(
        ...
        _req: crate::model::GetReplayRequest,
        _options: gax::options::RequestOptions,
    ) -> impl std::future::Future<Output = crate::Result<gax::response::Response<crate::model::Replay>>> {
        gaxi::unimplemented::unimplemented_stub()
    }
    ...
    fn list_replay_results(
        ...
        _req: crate::model::ListReplayResultsRequest,
        _options: gax::options::RequestOptions,
    ) -> impl std::future::Future<Output = crate::Result<gax::response::Response<crate::model::ListReplayResultsResponse>>> {
        gaxi::unimplemented::unimplemented_stub()
    }
