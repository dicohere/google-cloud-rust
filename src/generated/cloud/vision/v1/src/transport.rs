...
impl super::stub::ProductSearch for ProductSearch {
    ...
    async fn update_product_set(
        ...
        let path =
            format!("/v1/{}",
                    {
                        let arg = &req.product_set.as_ref().ok_or_else(|| gaxi::path_parameter::missing("product_set"))?.name;
                        if arg.is_empty() {
