...
impl super::stub::ManagedIdentitiesService for ManagedIdentitiesService {
    ...
    async fn update_domain(
        ...
        let path =
            format!("/v1/{}",
                    {
                        let arg = &req.domain.as_ref().ok_or_else(|| gaxi::path_parameter::missing("domain"))?.name;
                        if arg.is_empty() {
