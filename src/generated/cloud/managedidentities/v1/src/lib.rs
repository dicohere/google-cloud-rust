...
//!
//! This crate contains traits, types, and functions to interact with Managed Service for Microsoft Active Directory API
...
const DEFAULT_HOST: &str = "https://managedidentities.googleapis.com/";
