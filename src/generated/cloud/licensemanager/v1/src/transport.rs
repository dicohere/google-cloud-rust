...
impl super::stub::LicenseManager for LicenseManager {
    ...
    async fn update_configuration(
        ...
        let path =
            format!("/v1/{}",
                    {
                        let arg = &req.configuration.as_ref().ok_or_else(|| gaxi::path_parameter::missing("configuration"))?.name;
                        if arg.is_empty() {
