...
impl super::stub::AttachedClusters for AttachedClusters {
    ...
    async fn update_attached_cluster(
        ...
        let path =
            format!("/v1/{}",
                    {
                        let arg = &req.attached_cluster.as_ref().ok_or_else(|| gaxi::path_parameter::missing("attached_cluster"))?.name;
                        if arg.is_empty() {
    ...
    async fn import_attached_cluster(
        ...
        let path =
            format!("/v1/{}/attachedClusters:import",
                    {
                        let arg = &req.parent;
                        if arg.is_empty() {
                            return Err(gaxi::path_parameter::missing("parent"));
    ...
    async fn generate_attached_cluster_install_manifest(
        ...
        let path =
            format!("/v1/{}:generateAttachedClusterInstallManifest",
                    {
                        let arg = &req.parent;
                        if arg.is_empty() {
                            return Err(gaxi::path_parameter::missing("parent"));
    ...
    async fn generate_attached_cluster_agent_token(
        ...
        let path =
            format!("/v1/{}:generateAttachedClusterAgentToken",
                    {
...
impl super::stub::AwsClusters for AwsClusters {
    ...
    async fn update_aws_cluster(
        ...
        let path =
            format!("/v1/{}",
                    {
                        let arg = &req.aws_cluster.as_ref().ok_or_else(|| gaxi::path_parameter::missing("aws_cluster"))?.name;
                        if arg.is_empty() {
    ...
    async fn generate_aws_cluster_agent_token(
        ...
        let path =
            format!("/v1/{}:generateAwsClusterAgentToken",
                    {
    ...
    async fn generate_aws_access_token(
        ...
        let path =
            format!("/v1/{}:generateAwsAccessToken",
                    {
                        let arg = &req.aws_cluster;
                        if arg.is_empty() {
                            return Err(gaxi::path_parameter::missing("aws_cluster"));
    ...
    async fn update_aws_node_pool(
        ...
        let path =
            format!("/v1/{}",
                    {
                        let arg = &req.aws_node_pool.as_ref().ok_or_else(|| gaxi::path_parameter::missing("aws_node_pool"))?.name;
                        if arg.is_empty() {
    ...
    async fn get_aws_open_id_config(
        ...
        let path =
            format!("/v1/{}/.well-known/openid-configuration",
                    {
                        let arg = &req.aws_cluster;
                        if arg.is_empty() {
                            return Err(gaxi::path_parameter::missing("aws_cluster"));
...
impl super::stub::AzureClusters for AzureClusters {
    ...
    async fn update_azure_cluster(
        ...
        let path =
            format!("/v1/{}",
                    {
                        let arg = &req.azure_cluster.as_ref().ok_or_else(|| gaxi::path_parameter::missing("azure_cluster"))?.name;
                        if arg.is_empty() {
    ...
    async fn generate_azure_cluster_agent_token(
        ...
        let path =
            format!("/v1/{}:generateAzureClusterAgentToken",
                    {
    ...
    async fn generate_azure_access_token(
        ...
        let path =
            format!("/v1/{}:generateAzureAccessToken",
                    {
                        let arg = &req.azure_cluster;
                        if arg.is_empty() {
                            return Err(gaxi::path_parameter::missing("azure_cluster"));
    ...
    async fn update_azure_node_pool(
        ...
        let path =
            format!("/v1/{}",
                    {
                        let arg = &req.azure_node_pool.as_ref().ok_or_else(|| gaxi::path_parameter::missing("azure_node_pool"))?.name;
                        if arg.is_empty() {
