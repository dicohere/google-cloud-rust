...
impl super::stub::ReachabilityService for ReachabilityService {
    ...
    async fn update_connectivity_test(
        ...
        let path =
            format!("/v1/{}",
                    {
                        let arg = &req.resource.as_ref().ok_or_else(|| gaxi::path_parameter::missing("resource"))?.name;
                        if arg.is_empty() {
...
impl super::stub::VpcFlowLogsService for VpcFlowLogsService {
    ...
    async fn update_vpc_flow_logs_config(
        ...
        let path =
            format!("/v1/{}",
                    {
                        let arg = &req.vpc_flow_logs_config.as_ref().ok_or_else(|| gaxi::path_parameter::missing("vpc_flow_logs_config"))?.name;
                        if arg.is_empty() {
