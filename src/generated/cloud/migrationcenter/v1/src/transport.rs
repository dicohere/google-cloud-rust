...
impl super::stub::MigrationCenter for MigrationCenter {
    ...
    async fn report_asset_frames(
        ...
        let path =
            format!("/v1/{}/assets:reportAssetFrames",
                    {
                        let arg = &req.parent;
                        if arg.is_empty() {
                            return Err(gaxi::path_parameter::missing("parent"));
    ...
    async fn aggregate_assets_values(
        ...
        let path =
            format!("/v1/{}/assets:aggregateValues",
                    {
                        let arg = &req.parent;
                        if arg.is_empty() {
                            return Err(gaxi::path_parameter::missing("parent"));
    ...
    async fn update_import_job(
        ...
        let path =
            format!("/v1/{}",
                    {
                        let arg = &req.import_job.as_ref().ok_or_else(|| gaxi::path_parameter::missing("import_job"))?.name;
                        if arg.is_empty() {
    ...
    async fn update_preference_set(
        ...
        let path =
            format!("/v1/{}",
                    {
                        let arg = &req.preference_set.as_ref().ok_or_else(|| gaxi::path_parameter::missing("preference_set"))?.name;
                        if arg.is_empty() {
