...
impl super::stub::OrgPolicy for OrgPolicy {
    ...
    async fn update_custom_constraint(
        ...
        let path =
            format!("/v2/{}",
                    {
                        let arg = &req.custom_constraint.as_ref().ok_or_else(|| gaxi::path_parameter::missing("custom_constraint"))?.name;
                        if arg.is_empty() {
