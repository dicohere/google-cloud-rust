...
impl super::stub::DatasetService for DatasetService {
    ...
    async fn update_dataset(
        ...
        let path =
            format!("/v1/{}",
                    {
                        let arg = &req.dataset.as_ref().ok_or_else(|| gaxi::path_parameter::missing("dataset"))?.name;
                        if arg.is_empty() {
    ...
    async fn update_dataset_version(
        ...
        let path =
            format!("/v1/{}",
                    {
                        let arg = &req.dataset_version.as_ref().ok_or_else(|| gaxi::path_parameter::missing("dataset_version"))?.name;
                        if arg.is_empty() {
    ...
    async fn search_data_items(
        ...
        let builder = self
            ...
            .query(&[("$alt", "json;enum-encoding=int")])
            .header("x-goog-api-client", reqwest::header::HeaderValue::from_static(&crate::info::X_GOOG_API_CLIENT_HEADER));
        let builder = req.order_by_data_item().iter().fold(builder, |builder, p| builder.query(&[("orderByDataItem", p)]));
        let builder = req.order_by_annotation().map(|p| serde_json::to_value(p).map_err(Error::ser) ).transpose()?.into_iter().fold(builder, |builder, p| { use gaxi::query_parameter::QueryParameter; p.add(builder, "orderByAnnotation") });
        ...
        let builder = req.annotation_filters.iter().fold(builder, |builder, p| builder.query(&[("annotationFilters", p)]));
    ...
    async fn test_iam_permissions(
        ...
        let builder = self
            ...
            .query(&[("$alt", "json;enum-encoding=int")])
            .header("x-goog-api-client", reqwest::header::HeaderValue::from_static(&crate::info::X_GOOG_API_CLIENT_HEADER));
        let builder = req.permissions.iter().fold(builder, |builder, p| builder.query(&[("permissions", p)]));
        self.inner.execute(
            builder,
            Some(gaxi::http::NoBody),
            options,
    ...
    async fn wait_operation(
        ...
        let builder = self
            ...
            .query(&[("$alt", "json;enum-encoding=int")])
            .header("x-goog-api-client", reqwest::header::HeaderValue::from_static(&crate::info::X_GOOG_API_CLIENT_HEADER));
        let builder = req.timeout.as_ref().map(|p| serde_json::to_value(p).map_err(Error::ser) ).transpose()?.into_iter().fold(builder, |builder, v| { use gaxi::query_parameter::QueryParameter; v.add(builder, "timeout") });
        self.inner.execute(
            builder,
            Some(gaxi::http::NoBody),
            options,
...
impl super::stub::DeploymentResourcePoolService for DeploymentResourcePoolService {
    async fn create_deployment_resource_pool(
        ...
        let path =
            format!("/v1/{}/deploymentResourcePools",
                    {
                        let arg = &req.parent;
                        if arg.is_empty() {
                            return Err(gaxi::path_parameter::missing("parent"));
    ...
    async fn update_deployment_resource_pool(
        ...
        let path =
            format!("/v1/{}",
                    {
                        let arg = &req.deployment_resource_pool.as_ref().ok_or_else(|| gaxi::path_parameter::missing("deployment_resource_pool"))?.name;
                        if arg.is_empty() {
                            return Err(gaxi::path_parameter::missing("deployment_resource_pool.name"));
                        }
                        arg
                    },
            );
        ...
        self.inner.execute(
            builder,
            Some(req.deployment_resource_pool),
            options,
        ).await
    }
...
impl super::stub::EndpointService for EndpointService {
    ...
    async fn update_endpoint(
        ...
        let path =
            format!("/v1/{}",
                    {
                        let arg = &req.endpoint.as_ref().ok_or_else(|| gaxi::path_parameter::missing("endpoint"))?.name;
                        if arg.is_empty() {
...
impl super::stub::FeatureOnlineStoreAdminService for FeatureOnlineStoreAdminService {
    ...
    async fn update_feature_online_store(
        ...
        let path =
            format!("/v1/{}",
                    {
                        let arg = &req.feature_online_store.as_ref().ok_or_else(|| gaxi::path_parameter::missing("feature_online_store"))?.name;
                        if arg.is_empty() {
    ...
    async fn update_feature_view(
        ...
        let path =
            format!("/v1/{}",
                    {
                        let arg = &req.feature_view.as_ref().ok_or_else(|| gaxi::path_parameter::missing("feature_view"))?.name;
                        if arg.is_empty() {
...
impl super::stub::FeatureOnlineStoreService for FeatureOnlineStoreService {
    ...
    async fn search_nearest_entities(
        ...
        let path =
            format!("/v1/{}:searchNearestEntities",
                    {
                        let arg = &req.feature_view;
                        if arg.is_empty() {
                            return Err(gaxi::path_parameter::missing("feature_view"));
...
impl super::stub::FeatureRegistryService for FeatureRegistryService {
    ...
    async fn update_feature_group(
        ...
        let path =
            format!("/v1/{}",
                    {
                        let arg = &req.feature_group.as_ref().ok_or_else(|| gaxi::path_parameter::missing("feature_group"))?.name;
                        if arg.is_empty() {
    ...
    async fn batch_create_features(
        ...
        let path =
            format!("/v1/{}/features:batchCreate",
                    {
                        let arg = &req.parent;
                        if arg.is_empty() {
                            return Err(gaxi::path_parameter::missing("parent"));
    ...
    async fn update_feature(
        ...
        let path =
            format!("/v1/{}",
                    {
                        let arg = &req.feature.as_ref().ok_or_else(|| gaxi::path_parameter::missing("feature"))?.name;
                        if arg.is_empty() {
...
impl super::stub::FeaturestoreService for FeaturestoreService {
    ...
    async fn update_featurestore(
        ...
        let path =
            format!("/v1/{}",
                    {
                        let arg = &req.featurestore.as_ref().ok_or_else(|| gaxi::path_parameter::missing("featurestore"))?.name;
                        if arg.is_empty() {
    ...
    async fn update_entity_type(
        ...
        let path =
            format!("/v1/{}",
                    {
                        let arg = &req.entity_type.as_ref().ok_or_else(|| gaxi::path_parameter::missing("entity_type"))?.name;
                        if arg.is_empty() {
    ...
    async fn batch_read_feature_values(
        ...
        let path =
            format!("/v1/{}:batchReadFeatureValues",
                    {
    ...
    async fn search_features(
        ...
        let path =
            format!("/v1/{}/featurestores:searchFeatures",
                    {
                        let arg = &req.location;
                        if arg.is_empty() {
                            return Err(gaxi::path_parameter::missing("location"));
...
impl super::stub::GenAiCacheService for GenAiCacheService {
    ...
    async fn update_cached_content(
        ...
        let path =
            format!("/v1/{}",
                    {
                        let arg = &req.cached_content.as_ref().ok_or_else(|| gaxi::path_parameter::missing("cached_content"))?.name;
                        if arg.is_empty() {
...
impl super::stub::GenAiTuningService for GenAiTuningService {
    ...
    async fn rebase_tuned_model(
        ...
        let path =
            format!("/v1/{}/tuningJobs:rebaseTunedModel",
                    {
                        let arg = &req.parent;
                        if arg.is_empty() {
                            return Err(gaxi::path_parameter::missing("parent"));
...
impl super::stub::IndexEndpointService for IndexEndpointService {
    ...
    async fn update_index_endpoint(
        ...
        let path =
            format!("/v1/{}",
                    {
                        let arg = &req.index_endpoint.as_ref().ok_or_else(|| gaxi::path_parameter::missing("index_endpoint"))?.name;
                        if arg.is_empty() {
...
impl super::stub::IndexService for IndexService {
    ...
    async fn update_index(
        ...
        let path =
            format!("/v1/{}",
                    {
                        let arg = &req.index.as_ref().ok_or_else(|| gaxi::path_parameter::missing("index"))?.name;
                        if arg.is_empty() {
...
impl super::stub::JobService for JobService {
    ...
    async fn create_hyperparameter_tuning_job(
        ...
        let path =
            format!("/v1/{}/hyperparameterTuningJobs",
                    {
                        let arg = &req.parent;
                        if arg.is_empty() {
                            return Err(gaxi::path_parameter::missing("parent"));
        ...
        self.inner.execute(
            builder,
            Some(req.hyperparameter_tuning_job),
            options,
        ).await
    }
    ...
    async fn create_model_deployment_monitoring_job(
        ...
        let path =
            format!("/v1/{}/modelDeploymentMonitoringJobs",
                    {
                        let arg = &req.parent;
                        if arg.is_empty() {
                            return Err(gaxi::path_parameter::missing("parent"));
        ...
        self.inner.execute(
            builder,
            Some(req.model_deployment_monitoring_job),
            options,
        ).await
    }
    ...
    async fn search_model_deployment_monitoring_stats_anomalies(
        ...
        let path =
            format!("/v1/{}:searchModelDeploymentMonitoringStatsAnomalies",
                    {
                        let arg = &req.model_deployment_monitoring_job;
                        if arg.is_empty() {
                            return Err(gaxi::path_parameter::missing("model_deployment_monitoring_job"));
                        }
                        arg
                    },
            );
    ...
    async fn update_model_deployment_monitoring_job(
        ...
        let path =
            format!("/v1/{}",
                    {
                        let arg = &req.model_deployment_monitoring_job.as_ref().ok_or_else(|| gaxi::path_parameter::missing("model_deployment_monitoring_job"))?.name;
                        if arg.is_empty() {
                            return Err(gaxi::path_parameter::missing("model_deployment_monitoring_job.name"));
                        }
                        arg
                    },
            );
...
impl super::stub::MetadataService for MetadataService {
    ...
    async fn update_artifact(
        ...
        let path =
            format!("/v1/{}",
                    {
                        let arg = &req.artifact.as_ref().ok_or_else(|| gaxi::path_parameter::missing("artifact"))?.name;
                        if arg.is_empty() {
    ...
    async fn update_context(
        ...
        let path =
            format!("/v1/{}",
                    {
                        let arg = &req.context.as_ref().ok_or_else(|| gaxi::path_parameter::missing("context"))?.name;
                        if arg.is_empty() {
    ...
    async fn add_context_artifacts_and_executions(
        ...
        let path =
            format!("/v1/{}:addContextArtifactsAndExecutions",
                    {
                        let arg = &req.context;
                        if arg.is_empty() {
    ...
    async fn remove_context_children(
        ...
        let path =
            format!("/v1/{}:removeContextChildren",
                    {
                        let arg = &req.context;
                        if arg.is_empty() {
                            return Err(gaxi::path_parameter::missing("context"));
    ...
    async fn query_context_lineage_subgraph(
        ...
        let path =
            format!("/v1/{}:queryContextLineageSubgraph",
                    {
                        let arg = &req.context;
                        if arg.is_empty() {
                            return Err(gaxi::path_parameter::missing("context"));
    ...
    async fn update_execution(
        ...
        let path =
            format!("/v1/{}",
                    {
                        let arg = &req.execution.as_ref().ok_or_else(|| gaxi::path_parameter::missing("execution"))?.name;
                        if arg.is_empty() {
    ...
    async fn query_execution_inputs_and_outputs(
        ...
        let path =
            format!("/v1/{}:queryExecutionInputsAndOutputs",
                    {
                        let arg = &req.execution;
                        if arg.is_empty() {
                            return Err(gaxi::path_parameter::missing("execution"));
    ...
    async fn query_artifact_lineage_subgraph(
        ...
        let path =
            format!("/v1/{}:queryArtifactLineageSubgraph",
                    {
...
impl super::stub::MigrationService for MigrationService {
    async fn search_migratable_resources(
        ...
        let path =
            format!("/v1/{}/migratableResources:search",
                    {
                        let arg = &req.parent;
                        if arg.is_empty() {
                            return Err(gaxi::path_parameter::missing("parent"));
    ...
    async fn batch_migrate_resources(
        ...
        let path =
            format!("/v1/{}/migratableResources:batchMigrate",
                    {
                        let arg = &req.parent;
                        if arg.is_empty() {
                            return Err(gaxi::path_parameter::missing("parent"));
...
impl super::stub::ModelService for ModelService {
    ...
    async fn update_model(
        ...
        let path =
            format!("/v1/{}",
                    {
                        let arg = &req.model.as_ref().ok_or_else(|| gaxi::path_parameter::missing("model"))?.name;
                        if arg.is_empty() {
    ...
    async fn update_explanation_dataset(
        ...
        let path =
            format!("/v1/{}:updateExplanationDataset",
                    {
                        let arg = &req.model;
                        if arg.is_empty() {
...
impl super::stub::NotebookService for NotebookService {
    async fn create_notebook_runtime_template(
        ...
        let path =
            format!("/v1/{}/notebookRuntimeTemplates",
                    {
                        let arg = &req.parent;
                        if arg.is_empty() {
                            return Err(gaxi::path_parameter::missing("parent"));
        ...
        let builder = self
            ...
            .query(&[("$alt", "json;enum-encoding=int")])
            .header("x-goog-api-client", reqwest::header::HeaderValue::from_static(&crate::info::X_GOOG_API_CLIENT_HEADER));
        let builder = builder.query(&[("notebookRuntimeTemplateId", &req.notebook_runtime_template_id)]);
        self.inner.execute(
            builder,
    ...
    async fn update_notebook_runtime_template(
        ...
        let path =
            format!("/v1/{}",
                    {
                        let arg = &req.notebook_runtime_template.as_ref().ok_or_else(|| gaxi::path_parameter::missing("notebook_runtime_template"))?.name;
                        if arg.is_empty() {
                            return Err(gaxi::path_parameter::missing("notebook_runtime_template.name"));
                        }
                        arg
                    },
            );
    ...
    async fn assign_notebook_runtime(
        ...
        let path =
            format!("/v1/{}/notebookRuntimes:assign",
                    {
                        let arg = &req.parent;
                        if arg.is_empty() {
                            return Err(gaxi::path_parameter::missing("parent"));
    ...
    async fn create_notebook_execution_job(
        ...
        let path =
            format!("/v1/{}/notebookExecutionJobs",
                    {
                        let arg = &req.parent;
                        if arg.is_empty() {
                            return Err(gaxi::path_parameter::missing("parent"));
        ...
        self.inner.execute(
            builder,
            Some(req.notebook_execution_job),
            options,
        ).await
    }
...
impl super::stub::PersistentResourceService for PersistentResourceService {
    ...
    async fn update_persistent_resource(
        ...
        let path =
            format!("/v1/{}",
                    {
                        let arg = &req.persistent_resource.as_ref().ok_or_else(|| gaxi::path_parameter::missing("persistent_resource"))?.name;
                        if arg.is_empty() {
...
impl super::stub::PipelineService for PipelineService {
    ...
    async fn batch_delete_pipeline_jobs(
        ...
        let path =
            format!("/v1/{}/pipelineJobs:batchDelete",
                    {
                        let arg = &req.parent;
                        if arg.is_empty() {
                            return Err(gaxi::path_parameter::missing("parent"));
    ...
    async fn batch_cancel_pipeline_jobs(
        ...
        let path =
            format!("/v1/{}/pipelineJobs:batchCancel",
                    {
                        let arg = &req.parent;
                        if arg.is_empty() {
                            return Err(gaxi::path_parameter::missing("parent"));
...
impl super::stub::ReasoningEngineService for ReasoningEngineService {
    ...
    async fn update_reasoning_engine(
        ...
        let path =
            format!("/v1/{}",
                    {
                        let arg = &req.reasoning_engine.as_ref().ok_or_else(|| gaxi::path_parameter::missing("reasoning_engine"))?.name;
                        if arg.is_empty() {
...
impl super::stub::ScheduleService for ScheduleService {
    ...
    async fn update_schedule(
        ...
        let path =
            format!("/v1/{}",
                    {
                        let arg = &req.schedule.as_ref().ok_or_else(|| gaxi::path_parameter::missing("schedule"))?.name;
                        if arg.is_empty() {
...
impl super::stub::SpecialistPoolService for SpecialistPoolService {
    ...
    async fn update_specialist_pool(
        ...
        let path =
            format!("/v1/{}",
                    {
                        let arg = &req.specialist_pool.as_ref().ok_or_else(|| gaxi::path_parameter::missing("specialist_pool"))?.name;
                        if arg.is_empty() {
...
impl super::stub::TensorboardService for TensorboardService {
    ...
    async fn update_tensorboard(
        ...
        let path =
            format!("/v1/{}",
                    {
                        let arg = &req.tensorboard.as_ref().ok_or_else(|| gaxi::path_parameter::missing("tensorboard"))?.name;
                        if arg.is_empty() {
    ...
    async fn create_tensorboard_experiment(
        ...
        self.inner.execute(
            builder,
            Some(req.tensorboard_experiment),
            options,
        ).await
    }
    ...
    async fn update_tensorboard_experiment(
        ...
        let path =
            format!("/v1/{}",
                    {
                        let arg = &req.tensorboard_experiment.as_ref().ok_or_else(|| gaxi::path_parameter::missing("tensorboard_experiment"))?.name;
                        if arg.is_empty() {
    ...
    async fn update_tensorboard_run(
        ...
        let path =
            format!("/v1/{}",
                    {
                        let arg = &req.tensorboard_run.as_ref().ok_or_else(|| gaxi::path_parameter::missing("tensorboard_run"))?.name;
                        if arg.is_empty() {
    ...
    async fn create_tensorboard_time_series(
        ...
        let builder = self
            ...
            .query(&[("$alt", "json;enum-encoding=int")])
            .header("x-goog-api-client", reqwest::header::HeaderValue::from_static(&crate::info::X_GOOG_API_CLIENT_HEADER));
        let builder = builder.query(&[("tensorboardTimeSeriesId", &req.tensorboard_time_series_id)]);
        self.inner.execute(
            builder,
            Some(req.tensorboard_time_series),
            options,
        ).await
    }
    ...
    async fn update_tensorboard_time_series(
        ...
        let path =
            format!("/v1/{}",
                    {
                        let arg = &req.tensorboard_time_series.as_ref().ok_or_else(|| gaxi::path_parameter::missing("tensorboard_time_series"))?.name;
                        if arg.is_empty() {
                            return Err(gaxi::path_parameter::missing("tensorboard_time_series.name"));
                        }
                        arg
                    },
            );
    ...
    async fn batch_read_tensorboard_time_series_data(
        ...
        let builder = self
            ...
            .query(&[("$alt", "json;enum-encoding=int")])
            .header("x-goog-api-client", reqwest::header::HeaderValue::from_static(&crate::info::X_GOOG_API_CLIENT_HEADER));
        let builder = req.time_series.iter().fold(builder, |builder, p| builder.query(&[("timeSeries", p)]));
        self.inner.execute(
            builder,
            None::<gaxi::http::NoBody>,
            options,
    ...
    async fn export_tensorboard_time_series_data(
        ...
        let path =
            format!("/v1/{}:exportTensorboardTimeSeries",
                    {
                        let arg = &req.tensorboard_time_series;
                        if arg.is_empty() {
                            return Err(gaxi::path_parameter::missing("tensorboard_time_series"));
...
impl super::stub::VertexRagDataService for VertexRagDataService {
    ...
    async fn update_rag_corpus(
        ...
        let path =
            format!("/v1/{}",
                    {
                        let arg = &req.rag_corpus.as_ref().ok_or_else(|| gaxi::path_parameter::missing("rag_corpus"))?.name;
                        if arg.is_empty() {
...
impl super::stub::VizierService for VizierService {
    ...
    async fn check_trial_early_stopping_state(
        ...
        let path =
            format!("/v1/{}:checkTrialEarlyStoppingState",
                    {
                        let arg = &req.trial_name;
                        if arg.is_empty() {
                            return Err(gaxi::path_parameter::missing("trial_name"));
    ...
    async fn list_optimal_trials(
        ...
        let path =
            format!("/v1/{}/trials:listOptimalTrials",
                    {
                        let arg = &req.parent;
                        if arg.is_empty() {
                            return Err(gaxi::path_parameter::missing("parent"));
