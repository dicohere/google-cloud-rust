...
#[derive(Clone, Debug)]
pub struct CatalogService<T>
where T: super::stub::CatalogService + std::fmt::Debug {
    inner: T,
}
...
#[derive(Clone, Debug)]
pub struct CmekService<T>
where T: super::stub::CmekService + std::fmt::Debug {
    inner: T,
}
...
#[derive(Clone, Debug)]
pub struct ContentService<T>
where T: super::stub::ContentService + std::fmt::Debug {
    inner: T,
}
...
#[derive(Clone, Debug)]
pub struct DataTaxonomyService<T>
where T: super::stub::DataTaxonomyService + std::fmt::Debug {
    inner: T,
}
...
#[derive(Clone, Debug)]
pub struct DataScanService<T>
where T: super::stub::DataScanService + std::fmt::Debug {
    inner: T,
}
...
#[derive(Clone, Debug)]
pub struct DataplexService<T>
where T: super::stub::DataplexService + std::fmt::Debug {
    inner: T,
}
