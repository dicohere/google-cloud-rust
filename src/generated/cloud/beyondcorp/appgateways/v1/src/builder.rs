...
pub mod app_gateways_service {
    ...
    where R: std::default::Default {
        pub(crate) fn new(stub: std::sync::Arc<dyn super::super::stub::dynamic::AppGatewaysService>) -> Self {
            Self {
                stub,
                request: R::default(),
    ...
    impl ListAppGateways {
        ...
        pub async fn send(self) -> Result<crate::model::ListAppGatewaysResponse> {
            (*self.0.stub).list_app_gateways(self.0.request, self.0.options).await.map(gax::response::Response::into_body)
        }

        /// Streams each page in the collection.
        pub fn by_page(self) -> impl gax::paginator::Paginator<crate::model::ListAppGatewaysResponse, gax::error::Error> {
            use std::clone::Clone;
        ...
        pub fn by_item(self) -> impl gax::paginator::ItemPaginator<crate::model::ListAppGatewaysResponse, gax::error::Error> {
    ...
    impl GetAppGateway {
        ...
        pub async fn send(self) -> Result<crate::model::AppGateway> {
            (*self.0.stub).get_app_gateway(self.0.request, self.0.options).await.map(gax::response::Response::into_body)
        }
    ...
    impl CreateAppGateway {
        ...
        /// Sets the full request, replacing any prior values.
        pub fn with_request<V: Into<crate::model::CreateAppGatewayRequest>>(mut self, v: V) -> Self {
            self.0.request = v.into();
            self
        }
        ...
        pub async fn send(self) -> Result<longrunning::model::Operation> {
            (*self.0.stub).create_app_gateway(self.0.request, self.0.options).await.map(gax::response::Response::into_body)
        }
        ...
        {
            type Operation = lro::internal::Operation<crate::model::AppGateway, crate::model::AppGatewayOperationMetadata>;
    ...
    impl DeleteAppGateway {
        ...
        /// Sets the full request, replacing any prior values.
        pub fn with_request<V: Into<crate::model::DeleteAppGatewayRequest>>(mut self, v: V) -> Self {
            self.0.request = v.into();
            self
        }
        ...
        pub async fn send(self) -> Result<longrunning::model::Operation> {
            (*self.0.stub).delete_app_gateway(self.0.request, self.0.options).await.map(gax::response::Response::into_body)
        }
        ...
        pub fn poller(
            ...
            impl lro::Poller<(), crate::model::AppGatewayOperationMetadata>
        {
            type Operation = lro::internal::Operation<wkt::Empty, crate::model::AppGatewayOperationMetadata>;
            let polling_error_policy = self.0.stub.get_polling_error_policy(&self.0.options);
            let polling_backoff_policy = self.0.stub.get_polling_backoff_policy(&self.0.options);
