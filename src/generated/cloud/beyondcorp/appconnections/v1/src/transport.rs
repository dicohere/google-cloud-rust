...
impl super::stub::AppConnectionsService for AppConnectionsService {
    ...
    async fn update_app_connection(
        ...
        let path =
            format!("/v1/{}",
                    {
                        let arg = &req.app_connection.as_ref().ok_or_else(|| gaxi::path_parameter::missing("app_connection"))?.name;
                        if arg.is_empty() {
                            return Err(gaxi::path_parameter::missing("app_connection.name"));
                        }
                        arg
                    },
            );
    ...
    async fn resolve_app_connections(
        ...
        let path =
            format!("/v1/{}/appConnections:resolve",
                    {
                        let arg = &req.parent;
                        if arg.is_empty() {
                            return Err(gaxi::path_parameter::missing("parent"));
