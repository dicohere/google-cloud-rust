...
pub mod app_connections_service {
    ...
    where R: std::default::Default {
        pub(crate) fn new(stub: std::sync::Arc<dyn super::super::stub::dynamic::AppConnectionsService>) -> Self {
            Self {
                stub,
                request: R::default(),
    ...
    impl ListAppConnections {
        ...
        pub fn with_request<V: Into<crate::model::ListAppConnectionsRequest>>(mut self, v: V) -> Self {
        ...
        pub async fn send(self) -> Result<crate::model::ListAppConnectionsResponse> {
            (*self.0.stub).list_app_connections(self.0.request, self.0.options).await.map(gax::response::Response::into_body)
        }

        /// Streams each page in the collection.
        pub fn by_page(self) -> impl gax::paginator::Paginator<crate::model::ListAppConnectionsResponse, gax::error::Error> {
            use std::clone::Clone;
        ...
        pub fn by_item(self) -> impl gax::paginator::ItemPaginator<crate::model::ListAppConnectionsResponse, gax::error::Error> {
    ...
    impl GetAppConnection {
        ...
        /// Sets the full request, replacing any prior values.
        pub fn with_request<V: Into<crate::model::GetAppConnectionRequest>>(mut self, v: V) -> Self {
            self.0.request = v.into();
            self
        }
        ...
        pub async fn send(self) -> Result<crate::model::AppConnection> {
            (*self.0.stub).get_app_connection(self.0.request, self.0.options).await.map(gax::response::Response::into_body)
        }
    ...
    impl CreateAppConnection {
        ...
        /// Sets the full request, replacing any prior values.
        pub fn with_request<V: Into<crate::model::CreateAppConnectionRequest>>(mut self, v: V) -> Self {
            self.0.request = v.into();
            self
        }
        ...
        pub async fn send(self) -> Result<longrunning::model::Operation> {
            (*self.0.stub).create_app_connection(self.0.request, self.0.options).await.map(gax::response::Response::into_body)
        }
        ...
        {
            type Operation = lro::internal::Operation<crate::model::AppConnection, crate::model::AppConnectionOperationMetadata>;
    ...
    impl UpdateAppConnection {
        ...
        /// Sets the full request, replacing any prior values.
        pub fn with_request<V: Into<crate::model::UpdateAppConnectionRequest>>(mut self, v: V) -> Self {
            self.0.request = v.into();
            self
        }
        ...
        pub async fn send(self) -> Result<longrunning::model::Operation> {
            (*self.0.stub).update_app_connection(self.0.request, self.0.options).await.map(gax::response::Response::into_body)
        }
    ...
    impl DeleteAppConnection {
        ...
        /// Sets the full request, replacing any prior values.
        pub fn with_request<V: Into<crate::model::DeleteAppConnectionRequest>>(mut self, v: V) -> Self {
            self.0.request = v.into();
            self
        }
        ...
        pub async fn send(self) -> Result<longrunning::model::Operation> {
            (*self.0.stub).delete_app_connection(self.0.request, self.0.options).await.map(gax::response::Response::into_body)
        }
        ...
        pub fn poller(
            ...
            impl lro::Poller<(), crate::model::AppConnectionOperationMetadata>
        {
            type Operation = lro::internal::Operation<wkt::Empty, crate::model::AppConnectionOperationMetadata>;
            let polling_error_policy = self.0.stub.get_polling_error_policy(&self.0.options);
            let polling_backoff_policy = self.0.stub.get_polling_backoff_policy(&self.0.options);
    ...
    impl ResolveAppConnections {
        ...
        /// Sets the full request, replacing any prior values.
        pub fn with_request<V: Into<crate::model::ResolveAppConnectionsRequest>>(mut self, v: V) -> Self {
            self.0.request = v.into();
            self
        }
        ...
        pub async fn send(self) -> Result<crate::model::ResolveAppConnectionsResponse> {
            (*self.0.stub).resolve_app_connections(self.0.request, self.0.options).await.map(gax::response::Response::into_body)
        }

        /// Streams each page in the collection.
        pub fn by_page(self) -> impl gax::paginator::Paginator<crate::model::ResolveAppConnectionsResponse, gax::error::Error> {
            use std::clone::Clone;
            let token = self.0.request.page_token.clone();
            let execute = move |token: String| {
                let mut builder = self.clone();
        ...
        /// Streams each item in the collection.
        pub fn by_item(self) -> impl gax::paginator::ItemPaginator<crate::model::ResolveAppConnectionsResponse, gax::error::Error> {
            use gax::paginator::Paginator;
            self.by_page().items()
        }
