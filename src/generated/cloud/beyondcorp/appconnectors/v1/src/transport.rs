...
impl super::stub::AppConnectorsService for AppConnectorsService {
    ...
    async fn update_app_connector(
        ...
        let path =
            format!("/v1/{}",
                    {
                        let arg = &req.app_connector.as_ref().ok_or_else(|| gaxi::path_parameter::missing("app_connector"))?.name;
                        if arg.is_empty() {
