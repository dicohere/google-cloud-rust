...
//!
//! This crate contains traits, types, and functions to interact with Cloud Video Intelligence API
...
const DEFAULT_HOST: &str = "https://videointelligence.googleapis.com/";
