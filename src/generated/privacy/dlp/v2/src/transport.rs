...
impl super::stub::DlpService for DlpService {
    ...
    async fn list_file_store_data_profiles(
        ...
        let path =
            format!("/v2/{}/fileStoreDataProfiles",
                    {
                        let arg = &req.parent;
                        if arg.is_empty() {
                            return Err(gaxi::path_parameter::missing("parent"));
