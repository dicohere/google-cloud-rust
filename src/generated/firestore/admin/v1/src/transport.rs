...
impl super::stub::FirestoreAdmin for FirestoreAdmin {
    ...
    async fn update_field(
        ...
        let path =
            format!("/v1/{}",
                    {
                        let arg = &req.field.as_ref().ok_or_else(|| gaxi::path_parameter::missing("field"))?.name;
                        if arg.is_empty() {
